...
namespace PayxApi.Implementations.Services
{
    public class EmployeeService : IEmployeeService
    {
        ...
        public async Task<BaseResponse<EmployeeDTO>> GetEmployeeAllowance(int id)
        {
            var emp = await _employeeRepository.GetEmployeeAllowance(id);
            return new BaseResponse<EmployeeDTO>
            {
                IsSuccess = true,
                Message = "Success",
        ...
        public async Task<BaseResponse<EmployeeDTO>> GetGivenDeductionsAndBonus(int id)
        {
            var emp = await _employeeRepository.GetGivenDeductionsAndBonus(id);
            return new BaseResponse<EmployeeDTO>
            {
                IsSuccess = true,
                Message = "Success",
